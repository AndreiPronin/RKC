...
namespace BE.SocialHiring
{
    public class HelpCalculationsModel
    {
        ...
        public decimal? HeatingСalculationGcal { get; set; }
        public decimal? HeatingRecalculationRate { get; set; }
        public decimal? GvsHeatingСalculationGcal { get; set; }
        public decimal? GvsHeatingRecalculationRate { get; set; }
        public decimal? HvHeatingСalculationGcal { get; set; }
        public decimal? HvHeatingRecalculationRate { get; set; }
